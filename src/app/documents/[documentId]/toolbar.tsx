...
const HeadingLevelButton = () => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="p-1 flex flex-col gap-y-1 z-[999] bg-white shadow-sm rounded-sm">
...
const TextColorButton = () => {
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="z-[999] bg-white shadow-sm rounded-sm">
